                ...
                <div class="row content-margin2">
                    <div class="col-lg-12 mt-20 mt-lg-0">
                        <div class="d-flex justify-content-start align-items-center col-form-label mt-5 mt-lg-0">
                            <h1 style="margin-right: auto; font-size: 28px; color: #071437;">Not Complete Bills</h1>
                        </div>
...
const reload = async () => {
    ...
    try {
        const tableData = (
            await axios.get(route('notComplete.all'), {
                params: {
                    page: page.value,
...
const getHoldCartOrders = async () => {
    ...
    try {
        const tableData = (await axios.get(route('notComplete.all'))).data;
