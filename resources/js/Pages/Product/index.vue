                ...
                <div class="row content-margin2">
                    <div class="col-lg-12 mt-20 mt-lg-0">
                        <div class="d-flex justify-content-start align-items-center col-form-label mt-5 mt-lg-0">
                            ...
                            <Link :href="route('products.category')" class="btn btn-light-primary me-3"
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form @submit.prevent="saveProduct" enctype="multipart/form-data">
                                ...
                                <div class="col-form-label text-gray-600">Product Category</div>
                                ...
                                <div class="col-form-label text-gray-600">Product Price</div>
                                ...
                                <div class="col-form-label text-gray-600">Product Quantity</div>
                                <input v-model="product.stock_quantity" type="text" class="form-control form-control-sm"
                                    placeholder="Product quantity" />

                                <!-- <div class="col-form-label text-gray-600">Unit Type</div>
                                <Multiselect v-model="select_unit" :options="units" class="z__index" :showLabels="false"
                                    :close-on-select="true" :clear-on-select="false" :searchable="true"
                                    placeholder="Select Unit" label="title" track-by="id" /> -->

                                <div class="col-form-label text-gray-600">Product Image</div>
                                ...
                                <div class="col-form-label text-gray-600">Description</div>
                                ...
                                <div class="row">
                                    <div class="col-12 mt-4 text-end">
                                        <button type="submit" class="btn btn-light-primary" style="font-weight: bold">
                                            SAVE
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form @submit.prevent="updateProduct" enctype="multipart/form-data">
                                <div class="col-form-label text-gray-600">Name</div>
                                <input v-model="edit_product.name" type="text" class="form-control form-control-sm"
                                    placeholder="Product name" />

                                <div class="col-form-label text-gray-600">Product Category</div>
                                <Multiselect v-model="select_edit_category" :options="categories" class="z__index"
                                    :showLabels="false" :close-on-select="true" :clear-on-select="false" :searchable="true"
                                    placeholder="Select Category" label="name" track-by="id" />

                                <div class="col-form-label text-gray-600">Product Price</div>
                                <input v-model="edit_product.cost" type="cost" class="form-control form-control-sm"
                                    placeholder="Product price" />

                                <div class="col-form-label text-gray-600">Selling Price</div>
                                <input v-model="edit_product.selling" type="text" class="form-control form-control-sm"
                                    placeholder="Product selling price" />

                                <div v-if="props.auth.user.user_role_id == 1"  class="col-form-label text-gray-600">Product Quantity</div>
                                <input v-model="edit_product.stock_quantity" type="text"
                                    class="form-control form-control-sm" placeholder="Product quantity" />

                                <!-- <div class="col-form-label text-gray-600">Unit Type</div>
                                <Multiselect v-model="select_edit_unit" :options="units" class="z__index"
                                    :showLabels="false" :close-on-select="true" :clear-on-select="false" :searchable="true"
                                    placeholder="Select Unit" label="title" track-by="id" /> -->

                                <div class="col-form-label text-gray-600">Product Image</div>
                                <input type="file" ref="fileInput" accept="image/jpg, image/png" id="product_image"
                                    class="form-control form-control-sm" @change="onFileChangeEdit" />
...
const editProduct = async (id) => {
    try {
        ...
        if (edit_product.value.product_category_id) {
            select_edit_category.value.id = edit_product.value.product_category_id;
        }
...
const updateProduct = async () => {
    ...
    try {
        ...
        await axios.post(route("product.update", edit_product.value.id), edit_product.value, {
            headers: {
                'Content-Type': 'multipart/form-data'
            }
        });
