        ...
        <thead>
            <tr class="bg-ash">
                <th style="text-align: middle;">
                    <div class="text-head">SELYN HANDICRAFTS (PVT) LTD</div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td width="70%" align="left" class="txt-size">
                                    {{ $gi->from_warehouse_name ? $gi->from_warehouse_name : '' }} -
                                    {{ $gi->to_warehouse_name ? $gi->to_warehouse_name : '' }}</td>
                            </tr>
                        </tbody>
                    </table>
                    <table width="100%">
        ...
        <thead>
            <tr>
                <td class="footer-content">
                    Created At {{ \Carbon\Carbon::parse($gi->created_at)->format('Y-m-d h:i: A') }}
                </td>
            </tr>
            <tr>
                <td class="footer-content">
