...
@section('content')
        ...
        <thead>
            <tr>
                <th width="25%">
                    ...
                    @else
                    <img src="logo/logo_b.png" class="brand-logo" style="height: 60px; width: 100px;" />
                    @endisset
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%" class="top-margin">
        <thead>
            <tr class="heading-bg-po">
                <th width="50%">
                    <div class="sub-title text-left">Invoice No : #{{ $order->code }}</div>
                </th>
                <th width="20%">
    ...
    {{-- <table cellspacing="0" cellpadding="0" border="0" width="100%" class="item-section">
        <thead class="">
            <tr class="row-bg">
                <td width="43%" align="center" class="td-style">
                    <b>Code</b>
                    <br />
                    <b>Description</b>
                </td>
                <td width="17%" align="center" class="td-style ">
                    <b>Qty</b>
                </td>
                <td width="15%" alinvoice-item-textign="center" class="td-style ">
                    <b>Dis. (Rs)</b>
                </td>
                <td width="25%" align="center" class="td-style ">
                    <b>Rate (Rs)</b>
                    <br />
                    <b>Total (Rs)</b>
                </td>
        ...
        <tbody class="">
            @foreach ($order->order_items as $key => $item)
                <tr class="row-bg ">
                    <td width="43%" align="left" class="">
                        <div class="invoice-item-text item-margin">
                            <b>{{ $item->fg_code }}</b>
                            @if ($item->fgData && $item->fgData->description)
                            <div class="dotted-line-hr" ></div>
                            <b>{{ $item->fgData?$item->fgData->description:'' }}</b>
                            @endif
                            @if ($item->voucher_id)
                                <div class="dotted-line-hr" ></div>
                                <b>Gift Voucher</b>
                    ...
                    <td width="17%" align="right" class="right-text-qty" >
                        <div class="invoice-item-text-qty item-margin">
                           <b> {{ $item->quantity }}</b>
                        </div>
                    </td>
                    <td width="15%" align="left" class="right-text">
                        <div class="item-margin">
                            <b>{{ number_format($item->discount, 2) }}</b>
                        </div>
                    </td>
                    <td width="25%" align="left" class="right-text  invoice-item-text">
                        <div class="invoice-item-text item-margin">
                            <b>{{ number_format($item->unit_price, 2) }}</b>
                            <br />
                            <b>{{ number_format($item->sub_total, 2) }}</b>
